 ...
 * @author cce
 */
public class TelaCadastroLogin  extends Application {
    private static Stage stage;//---> uma janela
    @Override
    public void start(Stage stage) throws Exception{
       
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/telaCadastroLogin.fxml"));//---> carrega FXML
